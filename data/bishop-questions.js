// New IDs and an explicit version preserve the meaning of earlier submissions.
window.BISHOP_QUESTION_SET='governance-2027-v2';
window.BISHOP_QUESTIONS=[
 ...
 {id:'intention',title:'Do you wish to continue serving as a leader for the coming year?',help:'If you intend to resign, select that option. The D.R.O.G.S Office will contact you privately.',type:'choice',options:['I wish to continue','I wish to resign','I need to discuss my position']}
];
